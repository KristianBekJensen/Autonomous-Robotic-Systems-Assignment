...
from MazeSolverV2 import MazeSolver
...
n_angles_discrete = 16
action_bits = 2
number_time_steps_training = 100
number_time_steps_eval = 1000

#l = (np.log2(n_angles_discrete)) * action_bits
l = n_angles_discrete * action_bits
l = int(l)
pop_size = 20
generations = 4

problem = MazeSolver(False, False, number_time_steps_training, n_angles_discrete)
...
problem = MazeSolver(False, True, number_time_steps_eval, n_angles_discrete)
